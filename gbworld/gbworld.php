...
/*
+----------------------------------------------------------------+
+	GB-World-Submenupage [v1.2] - Official GB-World.net WP-Plugin Page
            ...
            <div id="poststuff" class="metabox-holder" style="width: 100%;>
                    ...
                    <!-- Content -->
                        <div id="post-body" class="has-sidebar">
                            <div id="post-body-content" class="has-sidebar-content" style="width:90%">
								 	...
								 	<td valign="top" colspan="2" align="center">
										...
										<tr>
											<td>
												...
												<a href="http://www.gb-world.net" target="_blank"><img src="<?php echo $gxtb_info_path; ?>images/banner.png" class="gb_world"/></a>
											</td>
										</tr>
										<tr>
										<td height="30px"></td>
