...
**5.** After that visit the OpenGraph-Site and fill in all the Administrative and Blog-Tags correctly
...
+ **Important: it is now a must to enter a valid App-ID! Please enter a valid App-ID if you do not already have one!**
