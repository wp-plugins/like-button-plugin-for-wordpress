...
Tags: facebook, like button, open graph protocol, social plugins, fb, plugins, for wordpress, button, widget, sidebar widget, shortcode, like, generator
Requires at least: 2.7.x
Tested up to: 2.9.x
Stable tag: 1.4.5

ENGLISH/GERMAN: Adds a Shortcode [like], Like-Button-Widget and Facebook-Like-Buttons for every post/page. The Shortocde inserts the code for your Like-Button.You can add it where ever you want. Also a little Like-Button widget is then available  as well as a Like-Button after every post/page you choose. This widget includes a little Like-Button-Generator to make it easier for you to get a Like-Button to your sidebar.

== Description ==

**Facebook-Like-Button**
This plugin adds a Like-Button after every post/page you choose (you can exclude some IDs. These exlucded IDs will have no Like-Button). This widget includes a little Like-Button-Generator to make it easier for you to get a Like-Button to your sidebar, Shortcode or after every Post/Page. You could also choose the position of your like-button within the post/page.
...
| [GB-Forum-Topic](http://www.gangxtaboii.com/forum/viewtopic.php?f=15&t=14&start=0) |
| [FAQ](http://www.gangxtaboii.com/forum/viewtopic.php?f=25&p=26) |
...
| [GB-Application](http://www.gangxtaboii.com/forum/viewforum.php?f=20) |

== BUGS ==

If you find any bugs please report them at our forum: | [Support](http://gangxtaboii.com/forum/viewforum.php?f=22&start=0) |