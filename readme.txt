...
*   New: Admin-Bar Menu (WP 3.1+) with many options you can set right from the frontend of your blog *NEW*
...
+ New: Admin-Bar Menu (WP 3.1+) with many options you can set right from the frontend of your blog
