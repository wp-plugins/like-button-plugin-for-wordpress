...
/*
+----------------------------------------------------------------+
+	Like-Button-Plugin-For-Wordpress [v4.3.3] - GB-Cleaner [v1.1 Beta]
...
if ( isset($this->GBLikeButton['PluginInfo']['lVersion']) || isset($gxtb_fb_lB['lVersion']) ) {

	if ( version_compare($GBLikeButton['PluginInfo']['lVersion'], '4.4', '<') || version_compare($gxtb_fb_lB['lVersion'], '4.4', '<') ){
