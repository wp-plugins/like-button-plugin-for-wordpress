...
/*
+----------------------------------------------------------------+
+	Like-Button-Plugin-For-Wordpress [v4.3.2] - GB-Meta-Generator [v1.6 - FINAL]
...
} elseif ((isset($this->GBLikeButton['OpenGraph']['w3c']) && $this->GBLikeButton['OpenGraph']['w3c'] == 0) && (!isset($fbnometa) || !$fbnometa) && ( !isset($this->GBLikeButton['OpenGraph']['on']) || $this->GBLikeButton['OpenGraph']['on'])) {
	ob_start(array( $this, 'meta_output' ));
	ob_end_flush();
}
} # end function
