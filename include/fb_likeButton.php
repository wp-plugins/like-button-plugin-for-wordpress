...
############################## ACTION ##############################
		...
		add_filter('the_content', array( $this, 'gxtb_fb_lB_add_after_post' ),98);
...
############################## ACTION ##############################
		...
		#add_filter( 'the_excerpt', array( $this, 'gxtb_fb_lB_add_after_post' ) );
	}
...
#echo '<link rel="stylesheet" type="text/css" href="' . gxtb_fb_lB_PLUGIN_FOLDER. 'frontend/frontend.css" />
echo '<script type="text/javascript" src="' . gxtb_fb_lB_PLUGIN_FOLDER. 'frontend/frontend.js"></script>
';
