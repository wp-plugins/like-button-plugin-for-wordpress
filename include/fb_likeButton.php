...
/*
+----------------------------------------------------------------+
+	Like-Button-Plugin-For-Wordpress [v1.3.5]
...
function gxtb_fb_lB_footer_function() {
	...
	if($gxtb_fb_lB_settings['JDK'] && $gxtb_fb_lB_meta['appid'] != "") {
?>
<div id="fb-root"></div>
<script>
  window.fbAsyncInit = function() {
    FB.init({appId: '<?php echo $gxtb_fb_lB_meta['appid']; ?>', status: true, cookie: true,
             xfbml: true});
  };
  (function() {
