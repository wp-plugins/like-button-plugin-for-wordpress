...
/*
+----------------------------------------------------------------+
+	Like-Button-Plugin-For-Wordpress [v4.2.4] - Like-Button-Generator [v0.1]
...
function gxtb_fb_lB_Generate($url) {
	...
	$text = '<fb:like href="'. urlencode($gxtb_generator_content['url']) .'" layout="'. $gxtb_generator_content['layout'] .'" show_faces="'. $gxtb_generator_content['faces'] .'" width="'. $width .'" action="'. $gxtb_generator_content['verb'] .'"' . $font .'colorscheme="'. $gxtb_generator_content['color'] .'" '. $ref .'></fb:like>';
