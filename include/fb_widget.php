...
/*
+----------------------------------------------------------------+
+	Like-Button-Plugin-For-Wordpress [v4.2.3] - GB-FB-Widget [v1.0] - OFFEN: 1x
...
?>
    ...
    <p><label><?php _e('Title', 'gb_like_button'); ?> <b>(<?php _e('(required)</b>', 'gb_like_button'); ?></b><br />
    <input name="gxtb_fb_lB_widget_title" type="text" value="<?php echo $gxtb_fb_lB_data['title']; ?>" />
    </label></p>

    <p><label><?php _e('URL', 'gb_like_button'); ?> <b>(<?php _e('(required)</b>', 'gb_like_button'); ?></b><br />
...
?><iframe src="http://www.facebook.com/plugins/recommendations.php?<?php echo $domain; ?>width=<?php echo $width; ?>&amp;height=<?php echo $height; ?>&amp;header=<?php echo $header; ?>&amp;colorscheme=<?php echo $gxtb_fb_lB_data['rec_color']; ?>" scrolling="no" frameborder="0" style="border:<?php echo $border; ?>; overflow:hidden; width:<?php echo $width; ?>; height:<?php echo $height; ?>;" allowTransparency="true"></iframe>
<?php if( isset( $gxtb_fb_lB_data['rec_css'] ) && !empty( $gxtb_fb_lB_data['rec_css'] ) ) {
			echo '</div>';
		}
?>
...
?>
    ...
    <p><label><?php _e('Domain', 'gb_like_button'); ?> <b>(<?php _e('(required)</b>', 'gb_like_button'); ?></b><br />
