		        ...
		        <tbody>
                    ...
                    <tr>
                    	<td width="20%" rowspan="2" valign="middle" class="gb-table-header">
							<strong>
								<?php _e('How do I activate the Like-Button?', 'gb_like_button') ?>
							</strong>
						</td>
					...
					<tr>
                    	<td width="20%" rowspan="2" valign="middle" class="gb-table-header">
							<strong>
								<?php _e('Facebook-Generator-FAQ:', 'gb_like_button') ?>
							</strong>
						</td>
                        <td width="80%" valign="middle">
							<ol>
					...
					<tr>
                    	<td width="20%" rowspan="2" valign="middle" class="gb-table-header">
							<strong>
								<?php _e('[like]-Shortcode', 'gb_like_button') ?>
							</strong>
						</td>
                        <td width="80%" valign="middle">
							<ol>
					...
					<tr>
                    	<td width="20%" rowspan="2" valign="middle" class="gb-table-header">
							<strong>
								<?php _e('Facebook-Like-Button-Widget', 'gb_like_button') ?>
							</strong>
						</td>
                        <td width="80%" valign="middle">
							<ol>
					...
					<tr>
                    	<td width="20%" rowspan="2" valign="middle" class="gb-table-header">
							<strong>
								<?php _e('The Tooltips do not work', 'gb_like_button') ?>  <img src="<?php echo gxtb_fb_lB_PLUGIN_FOLDER; ?>/images/rot17a.gif" onmouseover="tooltip.show('<?php _e('It works :)', 'gb_like_button'); ?>');" onmouseout="tooltip.hide();">
							</strong>
						</td>
                        <td width="80%" valign="middle">
							<ol>
					...
					<tr>
                    	<td width="20%" rowspan="2" valign="middle" class="gb-table-header">
							<strong>
								<?php _e('What is Facebook Insights Tools?', 'gb_like_button') ?>
							</strong>
						</td>
                        <td width="80%" valign="middle">
							<ol>
					...
					<tr>
                    	<td width="20%" rowspan="2" valign="middle" class="gb-table-header">
							<strong>
								<?php _e('What can I do if I need help?', 'gb_like_button') ?>
							</strong>
						</td>
                        <td width="80%" valign="middle">
							<ol>
