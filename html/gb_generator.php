...
<div id="iframe_info" style="visibility:visible">
	<?php if ($gxtb_fb_lB_settings['JDK']) { _e('You do not need this disabled options if you use the Java-SDK.', 'gb_like_button'); } ?>
</div>
<!-- END generator-settings for the iframe -->
          ...
          <td valign="top">
      		...
      		<p><label><?php _e('Language', 'gb_like_button'); ?><br />
                    ...
                    <img src="<?php echo $gb_fb_lB_path; ?>/images/rot17a.gif"  onmouseover="tooltip.show('<?php _e('You only need this if you activate the JavaSDK', 'gb_like_button'); ?>');" onmouseout="tooltip.hide();">
			</label></p>
            <small>
			...
			<br />
       		...
       		<p><b><?php _e('Preview', 'gb_like_button'); ?></b> <img src="<?php echo $gb_fb_lB_path; ?>/images/rot17a.gif"  onmouseover="tooltip.show('<?php _e('It will show a preview of a iFrame-FB-Like-Button. If the Java-SDK is enabled it will act a little bit different like this preview. Because the preview is always without the JavaSDK.', 'gb_like_button'); ?>');" onmouseout="tooltip.hide();"></p><br />
