...
';
echo '<link rel="stylesheet" type="text/css" href="' . $gb_fb_lB_path. 'css/admin.css" />
';
echo '<script type="text/javascript" src="' . $gb_fb_lB_path. 'js/gb_js.php?page=fb-like-button"></script>
';
}
...
########################################################################################################
	...
	function on_show_page() {
		...
		add_meta_box('gxtb_fb_lb_metabox-contentbox-5', __('Plugin-FAQ', 'gb_like_button') . ' [v ' . gxtb_fb_lB_version .  ']' , array(&$this, 'gxtb_contentbox_5'), $this->pagehook, 'side', 'core');
