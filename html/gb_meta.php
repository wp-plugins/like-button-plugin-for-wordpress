                    ...
                    <tr>
                        <td>
							<small>
									...
									<?php _e('<b>GB-Meta-Shortcodes:</b>  Site-Name => $binfo || Page-Title => $ptitle || Page-URL => $plink', 'gb_like_button') ?><br />
...
<?php ## ADITIONAL-META-TAGS ## ?>								
                    ...
                    <tr>
                    	<td width="20%" rowspan="2" valign="top"><strong><?php _e('Link-Relation', 'gb_like_button') ?></strong>  <img src="<?php echo $gb_fb_lB_path; ?>/images/rot17a.gif"  onmouseover="tooltip.show('<?php _e('<b>Important:</b> If you activate this option you have to add some attributes to your html-tag.', 'gb_like_button'); ?>');" onmouseout="tooltip.hide();"></td>
                        <td width="80%" valign="bottom">
					...
					<tr>
                        <td colspan="5">
							<div id="gxtb_fb_lB_meta_post_focus_div">&nbsp;</div>
						</td>
                    </tr>
               </tbody>
            </table>
...
?>
						...
						<table border="1" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td valign="bottom">							
									<div id="gxtb_fb_lB_meta_appid_div"><?php if(!$gxtb_fb_lB_settings['JDK']) { _e('AppID', 'gb_like_button'); } else { ?> <b><?php _e('AppID: (required)', 'gb_like_button'); ?></b>:<?php } ?></div>
								</td>
								<td valign="bottom">
							...
							<tr>
								...
								<td valign="bottom" colspan="2" rowspan="2">							
									<?php _e('You only have to enter one of this to Meta-Tags (Admin-ID or AppID) as long as you don not use the Java-SDK.', 'gb_like_button') ?><br />
                                    <?php _e('<b>APPID:</b> If you want to use the Java-SDK you have to enter a valid Facebook-App-ID (<a href="http://developers.facebook.com/setup/" target="_blank">GET an APPID</a>).', 'gb_like_button') ?><br />
...
function post_focus() {
	...
	if(document.settingpage.gxtb_fb_lB_meta_post_focus.checked == true) {
		div.innerHTML =
		"<img src=<?php echo bloginfo('wpurl'); ?>/wp-content/plugins/like-button-plugin-for-wordpress/screenshot-2.png>"
		+ "<br><br>"
