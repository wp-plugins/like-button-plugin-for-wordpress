...
?>
						<table border="1" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td valign="bottom">
									<input type="text" name="gxtb_fb_lB_meta_appid" value="<?php if ($gxtb_fb_lB_meta['app_id'] != "") {echo $gxtb_fb_lB_meta['app_id'];} else {echo "";} ?>" size="20"/> <img src="<?php echo $gb_fb_lB_path; ?>/images/rot17a.gif"  onmouseover="tooltip.show('<?php _e('<b>Notice:</b> Visit the Page mentioned below to get a valid AppID if you do not have one.', 'gb_like_button'); ?>');" onmouseout="tooltip.hide();">
								</td>
							</tr>	
