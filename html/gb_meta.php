...
/*
+----------------------------------------------------------------+
+	Like-Button-Plugin-For-Wordpress-Metaboxes [v1.3.6.2]
...
?>
						...
						<table border="1" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td valign="bottom">
									<input type="text" name="gxtb_fb_lB_meta_appid" value="<?php if ($gxtb_fb_lB_meta['app_id'] != "") {echo $gxtb_fb_lB_meta['app_id'];} else {echo "";} ?>" />
								</td>
							</tr>	
							...
							<tr>
								...
								<td valign="bottom" colspan="2" rowspan="2">							
                                    ...
                                    <?php _e('<b>APPID:</b> If you want to use the Java-SDK you have to enter a valid Facebook-App-ID.', 'gb_like_button') ?> <br />
                                	<?php _e('<b>Admin-ID:</b> Facebook-Profile-IDs of all Administrators of this Like-Button.', 'gb_like_button') ?><br />
								</td>
							</tr>
...
function post_focus() {
	...
	if(document.settingpage.gxtb_fb_lB_meta_post_focus.checked == true) {
		div.innerHTML =
		"<img src=<?php echo bloginfo('wpurl'); ?>/wp-content/plugins/like-button-plugin-for-wordpress/screenshot-1.png>"
		+ "<br><br>"
