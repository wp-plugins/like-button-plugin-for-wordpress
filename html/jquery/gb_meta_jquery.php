...
*/
########################################################################################################
class gxtb_fb_lB_mBMClassJQuery {

public static function gxtb_contentbox_4_jquery() {

	$gxtb_fb_lB_meta = get_option('gxtb_fb_lB_meta');
	$gxtb_fb_lB = get_option('gxtb_fb_lB');
	$metaContent = new metaContent(); // contains all the content
...
<table class="form-table" style="width:<?php echo $width;?>;" border="0" id="gb-table">
	<tbody>
		<tr>
			...
			<!-- Tabs-Menue -->
		<div class="ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs ui-widget ui-corner-all" id="tabs3">
...
<tr>
	<td colspan="3" valign="middle" align="left"><small>						
		...
		<br />
        <?php _e('<b>APPID:</b> If you want to use XFBML (Java-SDK) you have to enter a valid Facebook-App-ID (<a href="http://developers.facebook.com/setup/" target="_blank">GET an APPID</a>).', gxtb_fb_lB_lang) ?>
		<br />
