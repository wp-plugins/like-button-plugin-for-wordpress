...
<table class="form-table" style="width: 70%;" border="0">
		        <tbody>
                    ...
                    <tr>
                    	<td width="20%" rowspan="2" valign="top"><strong><a name="reldefinitions" style="color:#000000"><?php _e('Add the REF-Attribute', 'gb_like_button') ?></a></strong></td>
                    ...
                    <tr>
					 ...
					 <tr>
                    	<td width="20%" rowspan="2" valign="middle"><strong><?php _e('REF-Definitions', 'gb_like_button') ?></strong></td>
                    ...
                    <tr>
                        <td><small><?php _e('Use the ref attribute to help you test different placements and types of Like buttons. Append the ref="" attribute to the Like button, making sure that the value you choose is <b>less than 50 characters (a-z, A-Z, 0-9, + / = - . : _)</b>.', 'gb_like_button') ?></small></td>
                    </tr>
