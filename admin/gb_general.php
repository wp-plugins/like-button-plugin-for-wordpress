...
?>
                   ...
                   <tr>
                    ...
                    <tr>
                        <td class="gb-table-tipp">
							<b><?php _e('You have to enter a valid App-ID (OpenGraph-Page) and additionally the Admin-ID and Page-ID to provide valid tags and fulfill the requirements of the Like-Button!', gxtb_fb_lB_lang); ?></b>
							<small>
								<br />
