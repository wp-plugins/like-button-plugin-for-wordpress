...
/*
+----------------------------------------------------------------+
+	Like-Button-Plugin-For-Wordpress [v4.3.3] - GB-Meta-Page [v0.5 - FINAL]
...
<tr>
	<td valign="middle" width="20%">							
		<?php _e('Admin-IDs:', gxtb_fb_lB_lang) ?>
	</td>
	<td valign="bottom">				
<input type="text" name="admins" id="gxtb_fb_lB_meta_admins" class="{required:true, digits:true, messages:{required:'<?php _e('Enter a valid Admin-ID.', gxtb_fb_lB_lang) ?>', digits:'<?php _e('Only digits pls.', gxtb_fb_lB_lang) ?>'}}" value="<?php if (isset($this->GBLikeButton['OpenGraph']['admins']) && $this->GBLikeButton['OpenGraph']['admins'] != "") {echo $this->GBLikeButton['OpenGraph']['admins'];} else {echo "";} ?>" size="15"/> <img src="<?php echo gxtb_fb_lB_PLUGIN_FOLDER; ?>/images/rot17a.gif" onmouseover="tooltip.show('<?php _e('<b>Important:</b> The AdminID is your Facebook-Profile-ID or the FB-Profile-IDs of the other admins of this Like-Button.', gxtb_fb_lB_lang); ?>');" onmouseout="tooltip.hide();"> <?php echo sprintf( '<a href="%s" target="_blank" style="color:#900;border-bottom:1px dotted #900; text-decoration:none;">%s</a>', "http://apps.facebook.com/whatismyid/", "WhatsMyID" ); ?>
	</td>
</tr>
<tr>
	<td valign="bottom">							
		<div id="gxtb_fb_lB_meta_appid_div">
		<?php if(isset($this->GBLikeButton['General']['jdk']) && $this->GBLikeButton['General']['jdk'] != 1) { _e('AppID:', gxtb_fb_lB_lang); } else { ?> <b><?php _e('AppID: (required)', gxtb_fb_lB_lang); ?></b>:<?php } ?>
		</div>
	</td>
	<td valign="bottom">
		<input type="text" name="app_id" value="<?php if (isset($this->GBLikeButton['OpenGraph']['app_id']) && $this->GBLikeButton['OpenGraph']['app_id'] != "") {echo $this->GBLikeButton['OpenGraph']['app_id'];} else {echo "";} ?>" size="15"/> <img src="<?php echo gxtb_fb_lB_PLUGIN_FOLDER; ?>/images/rot17a.gif"  onmouseover="tooltip.show('<?php _e('<b>Notice:</b> Visit the Page mentioned below to get a valid AppID if you do not have one.', gxtb_fb_lB_lang); ?>');" onmouseout="tooltip.hide();"> <a href="admin.php?page=fb-like-faq#meta_app" style="color:#900;border-bottom:1px dotted #900; text-decoration:none;"><?php _e('More Help?', gxtb_fb_lB_lang); ?></a>
	</td>
</tr>					
<tr>
	<td>
	...
	<td>
		<input type="text" name="page_id" value="<?php if (isset($this->GBLikeButton['OpenGraph']['page_id']) && $this->GBLikeButton['OpenGraph']['page_id'] != "") {echo $this->GBLikeButton['OpenGraph']['page_id'];} else {echo "";} ?>" size="15"/> <img src="<?php echo gxtb_fb_lB_PLUGIN_FOLDER; ?>/images/rot17a.gif"  onmouseover="tooltip.show('<?php _e('You can also connect a Facebook-Fanpage with your Like-Buttons on your website. Just enter the Facebook-Fanpage-ID.', gxtb_fb_lB_lang); ?>');" onmouseout="tooltip.hide();">
	</td>
</tr>
<tr>
	<td colspan="3" valign="middle" align="left"><small>						
		<b><?php _e('You have to enter a valid App-ID and additionally the Admin-ID and Page-ID to provide valid tags and fulfill the requirements of the Like-Button!', gxtb_fb_lB_lang) ?></b>
		<br />
		...
		<br /><b>
        <?php _e('<b>APP-ID:</b> You have to enter a valid Facebook-App-ID if you want to use the Like-Button! (<a href="http://developers.facebook.com/setup/" target="_blank">GET an APPID</a>).', gxtb_fb_lB_lang) ?>
		</b><br />
...
?>
							...
							<tr>
								...
								<td valign="bottom" onmouseover="gxtb_blogtype()">                             
                                    ...
                                    ?>
                                    </SELECT> <img src="<?php echo gxtb_fb_lB_PLUGIN_FOLDER; ?>/images/rot17a.gif" style="visibility:hidden" id="gxtb_fb_lB_meta_type_img" onmouseover="" onmouseout="tooltip.hide();">
                    			</td>
							</tr>
...
<small>(<?php _e('Supported Images: PNG, JPEG/JPG and GIF', gxtb_fb_lB_lang) ?>)</small> 
							...
							<tr>
								...
								<td valign="bottom">                         
									...
									<input type="checkbox" class="checkbox" name="post_default" <?php if (isset($this->GBLikeButton['OpenGraph']['post_default']) && $this->GBLikeButton['OpenGraph']['post_default']) echo("checked"); ?> onmouseover="tooltip.show('<?php _e('Activate this checkbox if you want to use this ref-definition on every page where the Like-Button appears.', gxtb_fb_lB_lang ); ?> <?php _e(' If you deactive the default image on the Edit-Page the default image will not appear even though you have checked it here!', gxtb_fb_lB_lang ); ?>');" onmouseout="tooltip.hide();" value="1"/> <?php _e('Post', gxtb_fb_lB_lang ) ?>                             
                                    ...
                                    <tr>
                                   		<td><table><tr><td align="center" valign="middle">
                                             <div id="gxtb_img_preview_div">
												...
												echo '<a href="' . $this->GBLikeButton['OpenGraph']['image'] . '" class="preview" title="' . $this->GBLikeButton['OpenGraph']['image'] . '"><div class="thumb-img"><div class="thumb-inner"><img id="gxtb_fb_lB_meta_image_preview" src="' . $this->GBLikeButton['OpenGraph']['image'] . '" class="thumb" alt="' . $this->GBLikeButton['OpenGraph']['image'] . '"></div><div class="thumb-strip"></div><div class="thumb-zoom"></div></div></a>'; } else {echo _e('No Image set!', gxtb_fb_lB_lang); }?>
											</div>
							...
							<tr>
								<td valign="top" colspan="1">							
									<b><?php _e('Important Information and Help', gxtb_fb_lB_lang ) ?>:</b>
								</td>
								<td valign="top" colspan="5">
