...
/*
+----------------------------------------------------------------+
+	Like-Button-Plugin-For-Wordpress [v4.3] - GB-AdminPage [v1.0]
...
########################################################################################################
	...
	if ( version_compare( $wp_version, '2.8', '>=' ) ) {
		$this->pagehook = add_menu_page('FB-Like', "FB-Like", 0, 'fb-like-button', array(&$this, 'on_show_page'),  gxtb_fb_lB_PLUGIN_FOLDER .'images/admin.png');
	...
	$this->pagehook = add_submenu_page("fb-like-button", 'FB-General', 'General', 0, 'fb-like-button');
	$this->pagehook = add_submenu_page("fb-like-button", 'FB-Design', 'Design', 0, 'fb-like-design', array(&$this, 'gb_design'));
	$this->pagehook = add_submenu_page("fb-like-button", 'FB-OpenGraph', 'OpenGraph', 0, 'fb-like-opengraph', array(&$this, 'gb_meta'));
	$this->pagehook = add_submenu_page("fb-like-button", 'FB-Insights', 'FB-Insights', 0, 'fb-like-insights', array(&$this, 'gb_insights'));
	$this->pagehook = add_submenu_page("fb-like-button", 'FB-FAQ', 'FAQ', 0, 'fb-like-faq', array(&$this, 'gb_faq'));
	$this->pagehook = add_submenu_page("fb-like-button", 'GB-World', 'GB-World', 0, 'fb-like-gbworld', array(&$this, 'gb_infopage'));
