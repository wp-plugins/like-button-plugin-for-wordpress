...
### Info-Messages (Update, Information and everything else) ###
	...
	$this->GBMessageIncompability($GBLikeButton);
...
$text = "";	
				foreach ($GBLikeButton['PluginSetting']['Message'] as $key => $value) { 
					switch($key) {
					 ...
					 case ($key == "Update" && $GBLikeButton['PluginSetting']['Message']['Update'] > 0 && version_compare( gxtb_fb_lB_version, '4.4.4', '=') ):
						...
						__('Shortcode', gxtb_fb_lB_lang),
						__(' but also the new', gxtb_fb_lB_lang),
						__('Template-Function', gxtb_fb_lB_lang)				
						);
						$text .= "<br /><br />";
					 break;
					 ...
					 case ($key == "Support" && $GBLikeButton['PluginSetting']['Message']['Support'] > 0):
						...
						__('I worked over 24 hours for you and this update', gxtb_fb_lB_lang),
