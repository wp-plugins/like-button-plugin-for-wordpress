...
// Notice: http://www.design-ireland.net/?http%3A//www.design-ireland.net/article/Dynamic_Image_Resizing
...
function gxtb_image_src() {
	...
	div.innerHTML = "<img id='gxtb_fb_lB_meta_image_preview' src='" + src + "'>";
	...
	if(img.width > 400) {
		div.innerHTML = "<small>The image is to big to show a preview - but you can click <a href='"+ src +"' target='_blank'>here</a> to see the choosen Image.</small>";
	}
