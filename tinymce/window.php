	...
	<div class="panel_wrapper" style="height:100%">
		...
		<table border="0" cellpadding="4" cellspacing="0" height="100%">
         ...
         <tr>
            ...
            <td><SELECT NAME="gb_action" onchange="javascript:generate();">
					<?php
         ...
         <tr>
            ...
            <td><input type="text" id="gb_style" name="gb_style" style="width: 190px" onchange="javascript:generate();" /> (<?php _e("For example: border:solid;float:left;", gxtb_fb_lB_lang); ?>)</td>
         </tr>
            <td nowrap="nowrap" colspan="3">
				<label for="rsstag">
					<b><?php _e("Example", gxtb_fb_lB_lang); ?>:</b>
						<br />
					<small><?php _e("[like url=http://www.gb-world.net action=recommend width=100 height=150 style=border:none]", gxtb_fb_lB_lang); ?></small>
                    	<br /><br />
		...
		<script type="text/javascript">
			...
			if (document.gblikebutton_postform.gb_action.selectedIndex == 0) {
				...
				like.innerHTML = '<div' + gb_style + '><iframe src="http://www.facebook.com/plugins/like.php?href='+ gb_url +'&amp;layout=standard&amp;show_faces=true&amp;width=450&amp;action='+ gb_action +'&amp;colorscheme=light&amp;height='+ gb_height +'" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:'+ gb_width +'px; height:'+ gb_height +'px;" allowTransparency="true"></iframe></div>';
			}
