...
/*
	...
	Description: Adds a Shortcode [like] which inserts the code for your Like-Button-Plugin-For-Wordpress. A Like-Button widget is available as well as a Like-Button after every post/page you choose.
	Version: 1.3.7.5
...
if ( !defined( $gxt_fb_like_button_shortcode . '_version' ) )
	define( $gxt_fb_like_button_shortcode . '_version', "1.3.7.5" );
