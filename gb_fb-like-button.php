...
/*
	...
	Plugin URI: http://www.gangxtaboii.com/fb-like-button/
	Description: Adds a Shortcode [like] which inserts the code for your Like-Button-Plugin-For-Wordpress. You can add it where ever you want. Also a little Like-Button widget is now available.
	Version: 1.3.5
	Author: Stefan Natter
	Author URI: http://www.gangxtaboii.com
	Update Server: http://wordpress.org/extend/plugins/facebook-like-button
...
if ( !defined( $gxt_fb_like_button_shortcode . '_version' ) )
	define( $gxt_fb_like_button_shortcode . '_version', "1.3.5" );
...
if ( !defined( 'gxtb_fb_lB_FB_FILENAME' ) )
	...
	// Check for GB_FB-V1.5 installation
if (!defined ('IS_GB_FB_2_0'))
		define('IS_GB_FB_2_0', version_compare(gxtb_fb_lB_version, '2.0', '>=') );
...
function gxtb_fb_lB_widget_activate(){
  ...
  function gxtb_fb_lB_widget_deactivate(){
	...
	if(version_compare(gxtb_fb_lB_version, '1.3', '>')) {

		// Delete other Options
		delete_option('gxtb_fb_lB_activate');
		delete_option('gxtb_fb_lB_addfooter_activate');
		delete_option('gxtb_fb_lB_addfooter');
		delete_option('gxtb_fb_lB_code');
		
		delete_option('gxtb_fb_lB_post_focus');
		
		delete_option('gxtb_fb_lB_activate_frontpage');
		
		delete_option('gxtb_fb_lB_activate_page');
		delete_option('gxtb_fb_lB_page_exclude');
		
		delete_option('gxtb_fb_lB_activate_post');
		delete_option('gxtb_fb_lB_post_exclude');
		
		delete_option('gxtb_fb_lB_activate_archive');
		delete_option('gxtb_fb_lB_archive_exclude');
		
		delete_option('gxtb_fb_lB_activate_category');
		delete_option('gxtb_fb_lB_category_exclude');
		
		delete_option('gxtb_fb_lB_url');
		delete_option('gxtb_fb_lB_layout');
		delete_option('gxtb_fb_lB_faces');
		delete_option('gxtb_fb_lB_width');
		delete_option('gxtb_fb_lB_heigth');	
		delete_option('gxtb_fb_lB_verb');
		delete_option('gxtb_fb_lB_color');
	}
