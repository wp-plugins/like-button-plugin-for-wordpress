...
if ( !defined('gxtb_fb_lB_version' ) )
	define( 'gxtb_fb_lB_version', "4.4.4.3.1" );
...
########################################################################################################
	...
	$this -> GBLikeButtonAdminBar = new GBLikeButtonAdminBar();
	...
	if(!get_option('GBLikeButton')) {
		...
		$this->GBLikeButton = array (
			...
			'Expert' => array(
				...
				#'Meta' => '', # Meta-Output für Debug-Box
				#'LikeButton' => '' # Like-Button-Output für Debug-Box
			)); 
			...
			add_option('GBLikeButton', $this->GBLikeButton);
				...
				if($this->GBLikeButton['PluginSetting']['Message']['Help'] == 0) ## Message Output reset
					$this->GBLikeButton['PluginSetting']['Message']['Help'] += 3;
				if($this->GBLikeButton['PluginSetting']['Message']['Support'] == 0) ## Message Output reset
					$this->GBLikeButton['PluginSetting']['Message']['Support'] += 4;
				
				## Initialize new Options since v4.4.3.5 (currently achieved in this way - later in the GBCleaner-Tool) ##
				if(!array_key_exists('on', $this->GBLikeButton['OpenGraph'])) { $this->GBLikeButton['OpenGraph']['on'] = 1; } # New Option is set to 1
				if(!array_key_exists('w3c', $this->GBLikeButton['OpenGraph'])) { $this->GBLikeButton['OpenGraph']['w3c'] = 0; } # New Option is set to 1
				if(!array_key_exists('categorytype', $this->GBLikeButton['OpenGraph'])) { $this->GBLikeButton['OpenGraph']['categorytype'] = "blog"; } # New Option is set to "blog"
				if(!array_key_exists('archivetype', $this->GBLikeButton['OpenGraph'])) { $this->GBLikeButton['OpenGraph']['archivetype'] = "blog"; } # New Option is set to "blog"
				if(!array_key_exists('frontpage_default', $this->GBLikeButton['OpenGraph'])) { $this->GBLikeButton['OpenGraph']['frontpage_default'] = 1; } # New Option is set to 1
				if(!array_key_exists('page_default', $this->GBLikeButton['OpenGraph'])) { $this->GBLikeButton['OpenGraph']['page_default'] = 1; } # New Option is set to 1
				if(!array_key_exists('post_default', $this->GBLikeButton['OpenGraph'])) { $this->GBLikeButton['OpenGraph']['post_default'] = 1; } # New Option is set to 1
				if(!array_key_exists('category_default', $this->GBLikeButton['OpenGraph'])) { $this->GBLikeButton['OpenGraph']['category_default'] = 1; } # New Option is set to 1
				if(!array_key_exists('archive_default', $this->GBLikeButton['OpenGraph'])) { $this->GBLikeButton['OpenGraph']['archive_default'] = 1; } # New Option is set to 1
				if(!array_key_exists('send', $this->GBLikeButton['Generator'])) { $this->GBLikeButton['Generator']['send'] = 0; } # New Option is set to 0
				if(!array_key_exists('besidebutton', $this->GBLikeButton['Expert'])) { $this->GBLikeButton['Expert']['besidebutton'] = ""; }
				if(!array_key_exists('besideposition', $this->GBLikeButton['Expert'])) { $this->GBLikeButton['Expert']['besideposition'] = "right"; }
